...
# mixed logit + 1 PCA for Q12 only + full demographic controls
## mixed logit + 1 PCA for Q12 only + full demographic controls coefficients
```{r mixed_logit_pca_full_q12, echo=FALSE}
...
wtp.gmnl(mlogit_ctrl_efp1_12, wrt = "price")
```
