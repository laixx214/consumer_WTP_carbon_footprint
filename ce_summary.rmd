...
### WTP Plot, Co2 Consumption and Framing Effect
...
wtp_tbl%>%
    filter(
        grepl(" consequence| MetOffice| UN", var)
    ) %>%
    ggplot(
        aes(
            x = var,
    ...
    ylab("WTP") +
    xlab("Framing Effect: Consequence, Met Office, and UN Message Compared to Base Line")
