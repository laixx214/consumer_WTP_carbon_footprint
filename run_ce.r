...
################################################################################
### mixed logit + 1 principle component for Q9 and Q10 + reduced demographic controls
################################################################################
message("Running mixed logit with 1 principle component for Q9 and Q10 and reduced demographic controls...")
### mixed logit with controls
f <- formula(
    paste0(
        paste0(
...
################################################################################
### mixed logit + 1 principle component for Q9 and Q12 + reduced demographic controls
################################################################################
message("Running mixed logit with 1 principle component for Q9 and Q12 and reduced demographic controls...")
### mixed logit with controls
f <- formula(
    paste0(
        paste0(
...
################################################################################
### mixed logit + 1 principle component for Q9 and Q12 + full demographic controls
################################################################################
message("Running mixed logit with 1 principle component for Q9 and Q12 and demographic controls...")
### mixed logit with controls
f <- formula(
    paste0(
        paste0(
...
################################################################################
### mixed logit + co2 consumption + framing effect + 2 principle components for Q9 and Q12
################################################################################
message("Running mixed logit with co2 consumption, framing effect, and principle components for Q9 and Q12...")
### mixed logit with controls
f <- formula(
    paste0(
        paste0(
